...
function isNumeric(value) {
	...
	function displayStatus() {
		var updstatus = document.forms["regform"]["REGISTRATIONSTATUSMESSAGE"].value;
		alert("Event Added Succesfully!!!!----");
		
		if (updstatus == "Event added Succesfully !!!") {
			alert("Event Added Succesfully!!!!----");
			window.location.replace("http://localhost:8080/FestivalPortalR2_Participant/catalog.htm");
		}
	}
</script>
...
<body >
	...
	<input type="hidden" name="status" value="${REGISTRATIONSTATUSMESSAGE}">
				...
				<tr>
					...
					<table align="center" border="0">
					   ...
					   <tr>	
						   ...
						   <jstlcore:if test="${event.add == true}">									
						   	 <input value="Add New Event" type="submit" onclick = "displayStatus()">
						  
						     </jstlcore:if>
						     <jstlcore:if test="${event.add == false}" >									
						   	 <input value="Update Event" type="submit" onclick = "displayStatus()">
						    </jstlcore:if>
						   </td>
						</tr>
						<tr>						
